    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mt-15 mb-15">
                <asp:LinkButton runat="server" CssClass="btn btn-info">Agregar Usuario</asp:LinkButton>
            </div>
            <div class="col-md-12">
                <asp:GridView runat="server" ID="gvUsuarios" CssClass="table table-bordered table-hover" GridLines="None" AutoGenerateColumns="false"
                    ...
                    <Columns>
                            <asp:TemplateField HeaderText="Editar" ItemStyle-HorizontalAlign="Center" >
                              <ItemTemplate>
                                  <asp:LinkButton ID="lnkEditar" CommandArgument='<%# Eval("userId")%>' OnCommand="lnkEditar_Command" runat="server">
